...
// maybe we should keep a change log for each variant (store all enabled_layers)

var sampleMap = {results: "", enabled_layers: []}; 
...
function copyObject(obj){
    var copy = {};
    const returnedTarget = Object.assign(copy, obj);
    return copy;
}
